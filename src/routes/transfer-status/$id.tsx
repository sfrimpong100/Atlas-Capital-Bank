              ...
              {transfer.otp_verified ? (
                <div className="mt-4 rounded-xl border border-success/30 bg-success/10 p-4">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Your transfer is now ready for final approval by Atlas
                    Capital Bank.
                  </p>
                </div>
              ) : transfer.otp_code ? (
                <div className="mt-4 space-y-3">
                  <p className="text-sm text-muted-foreground">
                    An OTP has been generated for this transfer. Enter the OTP
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 px-4">
          <div className="w-full max-w-md rounded-2xl border border-border bg-background p-6 shadow-2xl">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Enter the OTP generated by Atlas Capital Bank to authorize this
              transfer.
            </p>

            {otpExpired && (
              <div className="mt-4 rounded-xl border border-destructive/30 bg-destructive/10 p-3 text-sm text-destructive">
                This OTP has expired. Please request a new OTP from the bank
                officer.
              </div>
            )}
            ...
            <Input
              ...
              maxLength={6}
              className="mt-5 h-12 text-center tracking-[0.5em] font-display text-xl"
              autoFocus
            />
